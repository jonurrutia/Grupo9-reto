...
public class InicioTrabajadores extends JFrame {
    public static void paginatr(){
        JFrame paginatr = new JFrame("");
        paginatr.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        paginatr.setSize(500, 500);
        paginatr.setLayout(new BorderLayout());

        JPanel p1 = new JPanel();

        //Logo arriba
        Image logoo=Toolkit.getDefaultToolkit().getImage(ClassLoader.getSystemResource("JUan_avion_Logo.png"));
        paginatr.setIconImage(logoo);


        //Color del frame
        Container c = paginatr.getContentPane();
        ...
        ParteArriba.add(Box.createVerticalGlue());
        paginatr.add(ParteArriba, BorderLayout.NORTH);
        ...
        paginatr.add(parte_abajo, BorderLayout.SOUTH);
