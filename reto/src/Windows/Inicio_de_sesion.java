...
public class Inicio_de_sesion extends JFrame {
    ...
    public Inicio_de_sesion() {
        ...
        iconFiltrar = iconFiltrar.getScaledInstance(25, 25, Image.SCALE_SMOOTH);
                    ...
                    try {
                        ...
                        if (password.equals(hash) && user.equals(user2)) {
                            if (trabajo.equals("recepcion")) {
                                ...
                                paginare.paginatr(recepcionista, c1);
                            ...
                            if (trabajo.equals("seguridad")) {
                                ...
                                paginase.paginatr(seguridad, c1);
        ...
        botonFiltrar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                if (decision == JOptionPane.YES_OPTION){
                    ...
                    JTable datos = new JTable(MostrarvuelosFiltrados(c1, Columnas, precio1, precio2), Columnas);
                    JPanel panelconscroll = new JPanel();
                    panelconscroll.setBackground(new Color(148, 223, 234));
                    panelconscroll.setBorder(new EmptyBorder(5, 5, 5, 5));
                    panelconscroll.add(datos);
                    ...
                    pagina_principal.add(vuelosFiltrados);
    ...
    public static int ContfilasFiltradas(Conexion c1, int precio1, int precio2) {
        int confilas=1;

        try {
            Statement buscar1 = c1.getConn().createStatement();
            ResultSet rs = buscar1.executeQuery("select v.ID_AVION, v.ID_VUELO, SALIDA, LLEGADA, HORA_PARTIDA, HORA_DESTINO, PRECIO from VUELOS v inner join PASAJE p on v.ID_VUELO=p.ID_VUELO where PRECIO >= "+precio1+" and PRECIO <= "+ precio2);
            while (rs.next()) {
                confilas++;
    ...
    public static String[][] MostrarvuelosFiltrados(Conexion c1, String[] Columnas, int precio1, int precio2) {
        String[][] Filas = new String[ContfilasFiltradas(c1, precio1, precio2)][7];
        try {
