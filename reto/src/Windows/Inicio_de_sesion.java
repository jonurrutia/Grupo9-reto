...
public class Inicio_de_sesion extends JFrame {
    ...
    public Inicio_de_sesion() {
        ...
        pagina_principal.setSize(525, 600);
                    ...
                    try {
                        ...
                        if (password.equals(hash) && user.equals(user2)) {
                            if (trabajo.equals("recepcion")) {
                                ...
                                Recepcionista recepcionista = new Recepcionista(numemp, user, Apellido, trabajo, hora_entrada, hora_entrada, sueldo, password, idaerolinia);
                            ...
                            if (trabajo.equals("piloto")) {
                                ...
                                Piloto piloto = new Piloto(numemp, user, Apellido, trabajo, hora_entrada, hora_entrada, sueldo, password, idaerolinia);
                            ...
                            if (trabajo.equals("seguridad")) {
                                ...
                                Seguridad seguridad = new Seguridad(numemp, user, Apellido, trabajo, hora_entrada, hora_entrada, sueldo, password, idaerolinia);
    ...
    public static String[][] Mostrarvuelos(Conexion c1, String[] Columnas) {
        String[][] Filas = new String[Contfilas(c1)][6];
        try {
