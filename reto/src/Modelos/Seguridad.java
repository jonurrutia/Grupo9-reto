...
public class Seguridad extends Empleado{
    ...
    public Seguridad(int numemp, String nombre, String apellido, String trabajo, String hora_entrada, String hora_salida, int Sueldo, String password, int Id_aeropuerto) {
